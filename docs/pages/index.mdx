...
[GraphDL.js](/nouns) translates the [GraphDL Schema](/nouns) into a [JavaScript Module](/nouns) with [TypeScript Types](/nouns), [JSON Schema](/nouns), [OpenAPI Spec](/nouns), [GraphQL Schema](/nouns), a [Static HTML](/nouns) or [NextJS Website](/nouns) and an [React Admin UI & App](/nouns).
