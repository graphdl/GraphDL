...
[GraphDL.js](/nouns) translates the [GraphDL Schema](/nouns) into a [Javascript ES6 Module](/nouns) with [Typescript Types](/nouns), 
as well as optionally [JSON Schema](/nouns), [OpenAPI Spec](/nouns), [GraphQL Schema](/nouns), a [Static HTML](/nouns) or [NextJS Site](/nouns) and an [React Admin App](/nouns).
