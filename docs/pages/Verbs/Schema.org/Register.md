...
<ul>
<li><Link href="/JoinAction">JoinAction</Link>: Unlike JoinAction, RegisterAction implies you are registering to be a user of a service, <em>not</em> a group/team of people.</li>
