...
<ul>
<li><Link href="/ScheduleAction">ScheduleAction</Link>: Unlike ScheduleAction, ReserveAction reserves concrete objects (e.g. a table, a hotel) towards a time slot / spatial allocation.</li>
</ul>
