...
<ul>
<li>Note 1: You can link to information about how the given value has been determined (e.g. reference RPM) using the <Link href="/valueReference">valueReference</Link> property.</li>
