...
<ul>
<li>Note 1: There are unfortunately no standard unit codes for liters per 100 km.  Use <Link href="/unitText">unitText</Link> to indicate the unit of measurement, e.g. L/100 km.</li>
