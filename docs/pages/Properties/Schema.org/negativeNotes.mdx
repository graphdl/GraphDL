...
Provides negative considerations regarding something, most typically in pro/con lists for reviews (alongside <Link href="/positiveNotes">positiveNotes</Link>). For symmetry <br/><br/>
