...
A <Link href="/NewsArticle">NewsArticle</Link> and <a class="localLink" href="/CriticReview">CriticReview</a> providing a professional critic's assessment of a service, product, performance, or artistic or literary work.
...
,* [associatedClaimReview](/Properties/Schema.org/associatedClaimReview)
,* [associatedMedia](/Properties/Schema.org/associatedMedia)
,* [associatedMediaReview](/Properties/Schema.org/associatedMediaReview)
,* [associatedReview](/Properties/Schema.org/associatedReview)
...
,* [dateline](/Properties/Schema.org/dateline)
...
,* [printColumn](/Properties/Schema.org/printColumn)
,* [printEdition](/Properties/Schema.org/printEdition)
,* [printPage](/Properties/Schema.org/printPage)
,* [printSection](/Properties/Schema.org/printSection)
...
,* [reviewBody](/Properties/Schema.org/reviewBody)
,* [reviewRating](/Properties/Schema.org/reviewRating)
