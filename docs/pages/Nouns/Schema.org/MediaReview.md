...
A <Link href="/MediaReview">MediaReview</Link> is a more specialized form of Review dedicated to the evaluation of media content online, typically in the context of fact-checking and misinformation.
...
,* [mediaAuthenticityCategory](/Properties/Schema.org/mediaAuthenticityCategory)
...
,* [originalMediaContextDescription](/Properties/Schema.org/originalMediaContextDescription)
,* [originalMediaLink](/Properties/Schema.org/originalMediaLink)
