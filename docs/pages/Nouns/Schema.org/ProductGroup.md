...
A ProductGroup represents a group of <Link href="/Product">Product</Link>s that vary only in certain well-described ways, such as by <a class="localLink" href="/size">size</a>, <a class="localLink" href="/color">color</a>, <a class="localLink" href="/material">material</a> etc.<br/><br/>
