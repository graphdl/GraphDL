...
A comment on an item - for example, a comment on a blog post. The comment's content is expressed via the <Link href="/text">text</Link> property, and its topic via <a class="localLink" href="/about">about</a>, properties shared with all CreativeWorks.
...
,* [downvoteCount](/Properties/Schema.org/downvoteCount)
...
,* [parentItem](/Properties/Schema.org/parentItem)
...
,* [upvoteCount](/Properties/Schema.org/upvoteCount)
