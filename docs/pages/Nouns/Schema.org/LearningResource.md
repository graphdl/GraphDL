...
The LearningResource type can be used to indicate <Link href="/CreativeWork">CreativeWork</Link>s (whether physical or digital) that have a particular and explicit orientation towards learning, education, skill acquisition, and other educational purposes.<br/><br/>
