...
An instance of a <Link href="/Course">Course</Link> which is distinct from other instances because it is offered at a different time or location or through different media or modes of study or to a specific section of students.
...
,* [courseMode](/Properties/Schema.org/courseMode)
,* [courseWorkload](/Properties/Schema.org/courseWorkload)
...
,* [instructor](/Properties/Schema.org/instructor)
