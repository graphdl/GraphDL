...
A grant, typically financial or otherwise quantifiable, of resources. Typically a <Link href="/funder">funder</Link> sponsors some <a class="localLink" href="/MonetaryAmount">MonetaryAmount</a> to an <a class="localLink" href="/Organization">Organization</a> or <a class="localLink" href="/Person">Person</a>,
