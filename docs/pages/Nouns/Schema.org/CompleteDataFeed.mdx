...
A <Link href="/CompleteDataFeed">CompleteDataFeed</Link> is a <a class="localLink" href="/DataFeed">DataFeed</a> whose standard representation includes content for every item currently in the feed.<br/><br/>
...
,* [catalog](/Properties/Schema.org/catalog)
...
,* [dataFeedElement](/Properties/Schema.org/dataFeedElement)
,* [datasetTimeInterval](/Properties/Schema.org/datasetTimeInterval)
...
,* [distribution](/Properties/Schema.org/distribution)
...
,* [includedDataCatalog](/Properties/Schema.org/includedDataCatalog)
,* [includedInDataCatalog](/Properties/Schema.org/includedInDataCatalog)
...
,* [variableMeasured](/Properties/Schema.org/variableMeasured)
,* [variablesMeasured](/Properties/Schema.org/variablesMeasured)
