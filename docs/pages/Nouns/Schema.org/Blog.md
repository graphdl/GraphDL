...
A <a href="https://en.wikipedia.org/wiki/Blog">blog</Link>, sometimes known as a "weblog". Note that the individual posts (<Link href="/BlogPosting">BlogPosting</a>s) in a <a class="localLink" href="/Blog">Blog</a> are often colloquially referred to by the same term.
...
,* [blogPost](/Properties/Schema.org/blogPost)
,* [blogPosts](/Properties/Schema.org/blogPosts)
