...
A CovidTestingFacility is a <Link href="/MedicalClinic">MedicalClinic</Link> where testing for the COVID-19 Coronavirus
...
,* [availableService](/Properties/Schema.org/availableService)
...
,* [isAcceptingNewPatients](/Properties/Schema.org/isAcceptingNewPatients)
...
,* [medicalSpecialty](/Properties/Schema.org/medicalSpecialty)
