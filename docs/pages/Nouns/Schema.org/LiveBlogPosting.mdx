...
A <Link href="/LiveBlogPosting">LiveBlogPosting</Link> is a <a class="localLink" href="/BlogPosting">BlogPosting</a> intended to provide a rolling textual coverage of an ongoing event through continuous updates.
...
,* [coverageEndTime](/Properties/Schema.org/coverageEndTime)
,* [coverageStartTime](/Properties/Schema.org/coverageStartTime)
...
,* [liveBlogUpdate](/Properties/Schema.org/liveBlogUpdate)
...
,* [sharedContent](/Properties/Schema.org/sharedContent)
