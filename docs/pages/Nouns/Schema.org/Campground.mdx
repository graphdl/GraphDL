...
A camping site, campsite, or <Link href="/Campground">Campground</Link> is a place used for overnight stay in the outdoors, typically containing individual <a class="localLink" href="/CampingPitch">CampingPitch</a> locations. <br/><br/>
...
,* [starRating](/Properties/Schema.org/starRating)
