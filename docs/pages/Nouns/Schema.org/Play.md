...
A play is a form of literature, usually consisting of dialogue between characters, intended for theatrical performance rather than just reading. Note: A performance of a Play would be a <Link href="/TheaterEvent">TheaterEvent</Link> or <a class="localLink" href="/BroadcastEvent">BroadcastEvent</a> - the <em>Play</em> being the <a class="localLink" href="/workPerformed">workPerformed</a>.
